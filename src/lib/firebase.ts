...
import { Product, Category, StockTransaction, ActivityLog } from '../types';

// Load directly from config or fallback to the specific applet credentials
const firebaseConfig = {
  projectId: "gen-lang-client-0844777126",
  appId: "1:139475638124:web:16e41fa186cba70b2b0549",
  apiKey: "AIzaSyDDYGWDQeU3I3YI7K_dfutyaPg678hB5NU",
  authDomain: "gen-lang-client-0844777126.firebaseapp.com",
  firestoreDatabaseId: "ai-studio-ec9ff443-dba8-48fa-b8b2-95958b491681",
  storageBucket: "gen-lang-client-0844777126.firebasestorage.app",
  messagingSenderId: "139475638124"
};
...
export async function seedDatabaseIfEmpty() {
  try {
    ...
    if (snapshot.empty) {
      console.log('Database is empty. Populating with initial Eco Plast data...');
      ...
      const initialProducts: Product[] = [
        ...
        },
        {
          ...
          unit: 'tons',
          quantity: 8,
          minStock: 15, // triggered low stock alert
        ...
        },
        {
          ...
          unit: 'kg',
          quantity: 0, // triggered out of stock alert
          minStock: 1000,
      ...
      initialLogs.forEach(lg => {
        const ref = doc(db, 'activity_logs', lg.id);
        batch.set(ref, lg);
      });
